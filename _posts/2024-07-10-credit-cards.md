...
Since I began researching and opening credit cards a bit over two years ago, I've saved **$9,740** and am projected to save about **$20,000** more over the next three years. 
...
In second grade I came across a children's book called *If You Made a Million*, which is essentially about how money makes money. Since then, I've always been fascinated by compound interest, passive income, travel hacking, and any other means by which to save a dollar in order to make it start working for me.
...
> If you found any information on this page helpful and have decided to get any of the credit cards I mentioned, **I would greatly appreciate it** if you would consider using one of the beloe refferal links to apply for your card! By using my links, I (and for some of the cards, yourself included) will receive a referral point bonus. Using these links as a card applicant is no different than the ordinary application links, but using them does really help me out. Thanks!
{: .prompt-tip}
